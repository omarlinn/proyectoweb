...
<html lang="en">
  <head>
    ...
    <!-- Links -->
    <link rel="stylesheet" href="<?php echo base_url('Site/css/contact-form.css');?>">
    <link rel="stylesheet" href="<?php echo base_url('Site/css/google-map.css');?>">
      ...
      <section>
        <div class="map map_height1">
          ...
          <ul class="map_locations">
            ...
            <li data-x="-74.100000" data-y="40.643180" data-basic="<?php echo base_url('Site');?>images/gmap_marker2.png" data-active="images/gmap_marker2_active.png">
              <div class="location">
                <h3 class="txt-clr1">
                  flooring
                  <small>
