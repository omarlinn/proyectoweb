...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="style1/images/favicon.ico" type="image/x-icon">
    <title>SERVICES</title>

    <!-- Bootstrap -->
    <link href="<?php echo base_url('Site/');?>style1/css/bootstrap.css" rel="stylesheet">

    <!-- Links -->
    <link rel="stylesheet" href="<?php echo base_url('Site/css/jquery.fancybox.css');?>">
    <link rel="stylesheet" href="<?php echo base_url('Site/css/search.css');?>">

    <!--JS-->
    <script src="<?php echo base_url('Site/js/jquery.js');?>"></script>
    <script src="<?php echo base_url('Site/js/jquery-migrate-1.2.1.min.js');?>"></script>
    <script src="<?php echo base_url('Site/js/rd-smoothscroll.min.js');?>"></script>
    ...
    <![endif]-->
    <script src='style1/js/device.min.js'></script>
  </head>
  <body>
  <div class="page">
  <!--========================================================
        ...
        <nav class="navbar navbar-default navbar-static-top pull-left">
            ...
            <div class="">
              <ul class="nav navbar-nav sf-menu" data-type="navbar">
                ...
                <li>
                  <a href="project.php">Registrate</a>
                </li>
  ...
  =========================================================-->
    ...
    <main>
        ...
        <div class="container">
          ...
          <div class="row offs3">
            <div class="col-md-4 col-sm-12 col-xs-12">
              <a class="thumb" data-fancybox-group='1' href="style1/images/page-3_img1_original.jpg">
                <img class="" src="style1/images/page-3_img1.jpg" alt="">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <a class="thumb" data-fancybox-group='1' href="style1/images/page-3_img2_original.jpg">
                <img class="" src="style1/images/page-3_img2.jpg" alt="">
                <span class='thumb_overlay'></span>
              </a>
              <p class="lead">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <a class="thumb" data-fancybox-group='1' href="style1/images/page-3_img3_original.jpg">
                <img class="" src="style1/images/page-3_img3.jpg" alt="">
                <span class='thumb_overlay'></span>
              </a>
              <p class="lead">
      ...
      <section class="well well6 parallax parallax1" data-url="style1/images/parallax2.jpg" data-mobile="
      true" data-speed="0.7">
        <div class="container">
        ...
        <div class="container">
          ...
          <div class="row offs3">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <img class="" src="style1/images/page-3_img4.jpg" alt="">
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 clear991">
              <img class="" src="style1/images/page-3_img5.jpg" alt="">
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
              <p class="lead lead_offs2">
                Ut enim ad minim veniam quis
          ...
          <div class="row row_offs">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <img class="" src="style1/images/page-3_img6.jpg" alt="">
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
              <p class="lead lead_offs2">
                Ut enim ad minim veniam quis
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 clear991">
              <img class="" src="style1/images/page-3_img7.jpg" alt="">
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
              <p class="lead lead_offs2">
                Ut enim ad minim veniam quis
  ...
  <footer>
   <section class="well1">
    ...
    <script src="<?php echo base_url('Site/js/tm-scripts.js');?>"></script>
  <!-- </script> -->
