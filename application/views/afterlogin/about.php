...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="<?php echo base_url('Site/css/bootstrap.css');?>" rel="stylesheet">
    ...
    <![endif]-->
    <script src='<?php echo base_url('Site/js/device.min.js');?>'></script>
  </head>
  <body>
  <div class="page">
  <!--========================================================
          ...
          <div class="row offs3 center767">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="thumbnail1">
                <img class="" src="<?php echo base_url();?>Site/images/page-2_img2.jpg" alt="">
                <div class="caption">
                  <h4>
                    <a href="#">
                      Inga North
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="thumbnail1">
                <img class="" src="<?php echo base_url();?>Site/images/page-2_img3.jpg" alt="">
                <div class="caption">
                  <h4>
                    <a href="#">
                      Tom Nelson
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="thumbnail1">
                <img class="" src="<?php echo base_url();?>Site/images/page-2_img4.jpg" alt="">
                <div class="caption">
                  <h4>
                    <a href="#">
                      Ivana Wong
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="thumbnail1">
                <img src="<?php echo base_url();?>Site/images/page-2_img5.jpg" alt="">
                <div class="caption">
                  <h4>
                    <a href="#">
                      Richard Cox
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <blockquote class="media offs3">
                <div class="media-left media_ins1">
                  <img src="<?php echo base_url();?>Site/images/page-2_img6.jpg" alt="">
                </div>
                <div class="media-body">
                  <p>
                    <q>
