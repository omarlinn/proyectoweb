...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo base_url('Site/');?>style1/images/favicon.ico" type="image/x-icon">
    <title>PRIVACY</title>
    ...
    <!-- Links -->
    <link rel="stylesheet" href="<?php echo base_url('Site/');?>style1/css/search.css">

    <!--JS-->
    <script src="<?php echo base_url('Site/');?>style1/js/jquery.js"></script>
    <script src="<?php echo base_url('Site/');?>style1/js/jquery-migrate-1.2.1.min.js"></script>
    <script src="<?php echo base_url('Site/');?>style1/js/rd-smoothscroll.min.js"></script>
    ...
    <![endif]-->
    <script src='<?php echo base_url('Site/');?>style1/js/device.min.js'></script>
  </head>
  <body>
  <div class="page">
  <!--========================================================
        ...
        <nav class="navbar navbar-default navbar-static-top pull-left">
            ...
            <div class="">
              <ul class="nav navbar-nav sf-menu" data-type="navbar">
                ...
                <li>
                  <a href="project.php">Registratr</a>
                </li>
