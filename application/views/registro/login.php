...
<form id="msform">
  ...
  <fieldset>
    ...
    <input type="text" name="pais" placeholder="direccion" />
  ...
  <fieldset>
    ...
    <h3 class="fs-subtitle">Registra tus datos profesiones</h3>
    <select name="nivel_academico">
    	<option value=""></option>
    	
    </select>
   	<select name="titulo_obtenido" >
...
tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
consequat. Duis aute irure dolor in reprehendeesserit in voluptate velit 
cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
